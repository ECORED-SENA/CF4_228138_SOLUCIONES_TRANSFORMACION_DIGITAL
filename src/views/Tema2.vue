...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p(data-aos="fade-down").mb-5 Las fases del modelo de ciclo del software son: planificación, análisis, diseño, implementación, pruebas y mantenimiento, las cuales se describen en la siguiente figura.
    .bg8.p-5
    ...
    .cajon-b.color-acento-contenido.mb-4.py-2
      .row.align-items-center.justify-content-center
        ...
        .col-10.my-3
          p(data-aos="fade-down") Con la finalidad de proporcionar una metodología común entre el cliente y la empresa de software, se utilizan los modelos de ciclos de vida o paradigmas de desarrollo de software para plasmar las etapas y la documentación necesaria, de manera que cada fase se valide antes de continuar con la siguiente.

          p(data-aos="fade-down") Un modelo de ciclo de vida de software es una vista de las actividades que ocurren durante el desarrollo de software e intenta determinar el orden de las etapas involucradas y los criterios de transición asociados entre estas.

    .row.align-items-center.justify-content-center.mb-4
      .col-lg-5.my-3
        img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/temas/50.png', alt='')
      .col-lg-7.my-3
        p(data-aos="fade-down") Según la norma 1074 IEEE se define al ciclo de vida del software como:
        .bloque-texto-b.color-primario.p-4.mb-4
          .bloque-texto-b__texto
            i.fas.fa-quote-left
            h2.mb-0 una aproximación lógica a la adquisición, el suministro, el desarrollo, la explotación y el mantenimiento del software
            i.fas.fa-quote-right 
        .cajon.color-secundario.p-4(data-aos="flip-down")
          p(data-aos="fade-down") La ISO/IEC 12207 Information Technology / Software Life Cycle Processes señala que es: 

          p(data-aos="fade-down").mb-0 Un marco de referencia que contiene los procesos, las actividades y las tareas involucradas en el desarrollo, la explotación y el mantenimiento de un producto de software, abarcando la vida del sistema desde la definición de los requisitos hasta la finalización de su uso (2008).        

    p(data-aos="fade-down").mb-5 Existen modelos preestablecidos con los cuales se pude elaborar un proyecto; a continuación, se mencionan los diferentes paradigmas de modelos de ciclo de vida para desarrollar software.  
    .row.mt-5(data-aos="fade-left")
      .col-12
        .row
          .col-2.col-lg-1.offset-1.align-self-center.justify-content-center
                    ...
                    ol.lista-ol--cuadro
                      li 
                        .lista-ol--cuadro__vineta.wtg-1
                          span.vtext 1
                        p.mb-0 Colecta y refinamiento de los requerimientos y proyecto rápido.
                      li.px-5
                        i.fas.fa-check.colorv
                        p.mb-0 Análisis.
                      li.px-5
                        i.fas.fa-check.colorv
                        p.mb-0 Especificación del prototipo.
                      li.mt-4 
                        .lista-ol--cuadro__vineta(style="width: 25px;")
                          span.vtext 2
                        p.mb-0 Diseño rápido.
                      li.mt-4 
                        .lista-ol--cuadro__vineta(style="width: 25px;")
                          span.vtext 3
                        p.mb-0 Construcción del prototipo.
                      li.mt-4 
                        .lista-ol--cuadro__vineta.wtg-4
                          span.vtext 4
                        p.mb-0 Evaluación del prototipo por el cliente.
                      li.mt-4 
                        .lista-ol--cuadro__vineta(style="width: 25px;")
                          span.vtext 5
                        p.mb-0 Refinamiento del prototipo.
                      li.px-5
                        i.fas.fa-check.colorv
                        p.mb-0 Diseño técnico.
                      li.px-5
                        i.fas.fa-check.colorv
                        p.mb-0 Programación y test.
                      li.px-5
                        i.fas.fa-check.colorv
                        p.mb-0 Operación y mantenimiento.
                      li.mt-4 
                        .lista-ol--cuadro__vineta(style="width: 25px;")
                          span.vtext 6
                        p.mb-0 Producto de ingeniería.
          ...
          .row.justify-content-center.align-items-center(titulo="Modelo Scrum.")
              ...
              .col-lg-6
                ol.lista-ol--cuadro
                  ...
                  li 
                    .lista-ol--cuadro__vineta.wtg-1
                      span.vtext 3
                    p.mb-0 Sprint Planning Meeting.    
              .col-lg-6
                ol.lista-ol--cuadro
                  li 
                    .lista-ol--cuadro__vineta.wtg-1
                  ...
                  li 
                    .lista-ol--cuadro__vineta.wtg-1
                      span.vtext 5
                    p.mb-0 Sprint Review.
                  li 
                    .lista-ol--cuadro__vineta.wtg-1
                      span.vtext 6
                    p.mb-0 Sprint Retrospective  
            ...
            ul.lista-ul
              li 
                ...
                p.mb-0 <b>Gestión regular de las expectativas del usuario:</b> los usuarios participan y proponen soluciones
              li 
                i.fas.fa-check.colorv2
                p.mb-0 <b>Resultados anticipados:</b> no es necesario esperar hasta el final para ver resultados
              li 
                i.fas.fa-check.colorv2
                p.mb-0 <b>Flexibilidad y adaptación:</b> se adapta a cualquier contexto, área o sector.
              li 
                i.fas.fa-check.colorv2
                p.mb-0 <b>Gestión sistemática de riesgos:</b> los problemas son gestionados en el mismo momento de su aparición. 
    ...
    datosSlyder: [
      {
        ...
        texto:
          'en esta primera fase se realiza el planteamiento del problema, se definen alcances y objetivos del software.<br><br><b>Objetivos:</b> estudio de viabilidad, realizar planificación detallada.',
        imagen: require('@/assets/curso/temas/44.png'),
      },
      {
        titulo: 'FASE ANÁLISIS (definición de requisitos):',
        texto:
          'esta fase busca definir los requisitos que son los que dirigirán el desarrollo del proyecto de software.<br><br><b>Objetivos:</b> conocer los requisitos, asegurar que los requisitos son alcanzables, formalizar acuerdo con el cliente.',
        imagen: require('@/assets/curso/temas/45.png'),
      },
      {
        titulo: 'FASE DISEÑO:',
        texto:
          'en esta fase se estudian posibles opciones de implementación para el software que hay que construir, estructura general del mismo.<br><br><b>Objetivos:</b> identificar soluciones tecnológicas, asignar recursos materiales, proponer identificar y seleccionar, establecer métodos de validación, ajustar especificaciones.',
